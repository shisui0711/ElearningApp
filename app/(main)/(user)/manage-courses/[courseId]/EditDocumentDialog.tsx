...
import { FileText, Loader2, Pencil, Upload, X } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.message || "Đã xảy ra lỗi khi cập nhật tài liệu");
      }
      ...
      <DialogContent className="sm:max-w-[600px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Chỉnh sửa thông tin tài liệu bài học.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label className="text-right">Tài liệu</Label>
              <div className="col-span-3">
                <Tabs
                  value={activeTab}
          ...
          <DialogFooter>
            <Button type="submit" disabled={loading}>
              {loading ? "Đang cập nhật..." : "Cập nhật tài liệu"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
