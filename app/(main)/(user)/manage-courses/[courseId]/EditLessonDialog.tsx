...
import { Loader2, Pencil, Upload, Video, X } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.message || "Đã xảy ra lỗi khi cập nhật bài học");
      }
      ...
      toast.error(error.message || "Đã xảy ra lỗi khi cập nhật bài học");
    } finally {
      setLoading(false);
    }
  };
      ...
      <DialogContent className="sm:max-w-[600px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Chỉnh sửa thông tin bài học của bạn.
            </DialogDescription>
          </DialogHeader>
